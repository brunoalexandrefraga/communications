...
# Gráfico de Rayleigh
axs[0].set_xlabel('|h|', fontsize=16)
axs[0].set_ylabel('pdf', fontsize=16)
axs[0].set_title('Rayleigh', fontsize=16)
axs[0].grid(True, alpha=0.5)
axs[0].plot(h, rayleigh_pdf)

# Gráfico de Rician
axs[1].set_xlabel('|h|', fontsize=16)
axs[1].set_ylabel('pdf', fontsize=16)
axs[1].set_title('Rician', fontsize=16)
axs[1].grid(True, alpha=0.5)

for K in Kvalues:
    rician = rician_dist(h, K)
    axs[1].plot(h, rician, label=f'K = {K}')

axs[1].legend(fontsize=16)

# Gráfico de Nakagami-m
axs[2].set_xlabel('|h|', fontsize=16)
axs[2].set_ylabel('pdf', fontsize=16)
axs[2].set_title('Nakagami-m', fontsize=16)
axs[2].grid(True, alpha=0.5)

for m in mvalues:
    naka = nakagami_m_dist(h, m)
    axs[2].plot(h, naka, label=f'm = {m}')
...
axs[0].set_xlabel('|h|', fontsize=16)
axs[0].set_ylabel('PDF density function', fontsize=16)
axs[0].set_title('Rayleigh', fontsize=16)
axs[0].grid(True, alpha=0.5)
axs[0].plot(h, rayleigh_power)
